...
const mockTenants = [
  ...
  },
  {
    ...
    contact: {
      ...
      address:
        'Av. Assis Chateaubriand, 890, Apto 202, Liberdade, Campina Grande - PB',
    },
    bankData: {
...
export default function AdicionarContrato() {
  ...
  const [selectedSecondProposerId, setSelectedSecondProposerId] =
    useState<string>('');
  ...
  const selectedSecondProposer = mockTenants.find(
    (t) => t.id === selectedSecondProposerId
  );
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                ...
                                <p className="text-sm font-medium">
                                  {selectedProperty.basicInfo.identification}
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground mb-1 text-sm">
                                ...
                                <p className="text-sm font-medium">
                                  {selectedProperty.basicInfo.status}
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground mb-1 text-sm">
                                ...
                                <p className="text-sm font-medium">
                                  {selectedProperty.basicInfo.type}
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground mb-1 text-sm">
                                ...
                                <p className="text-sm font-medium">
                                  {selectedProperty.basicInfo.area}
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground mb-1 text-sm">
                                ...
                                <p className="text-sm font-medium">
                                  {selectedProperty.basicInfo.bedrooms}
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground mb-1 text-sm">
                                ...
                                <p className="text-sm font-medium">
                                  {selectedProperty.basicInfo.bathrooms}
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground mb-1 text-sm">
                                ...
                                <p className="text-sm font-medium">
                                  {selectedProperty.basicInfo.parkingSpots}
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="space-y-4 rounded-lg border p-6">
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm font-medium">
                                  {selectedProperty.address.number}
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground mb-1 text-sm">
                ...
                <AccordionContent>
                  <CardContent className="space-y-4">
                    <Field>
                      ...
                      <Input id="renter-name" placeholder="Evíl Rabbit" />
                    </Field>

                    <div className="grid grid-cols-2 gap-4">
                      <Field>
                        <FieldLabel htmlFor="renter-cpf">CPF *</FieldLabel>
                        <Input id="renter-cpf" placeholder="XXX.XXX.XXX-XX" />
                      </Field>
                ...
                <AccordionContent>
                  <CardContent className="space-y-4">
                    ...
                    <Field>
                      ...
                      />
                      <FieldDescription>
                        Inclua quaisquer observações ou cláusulas especiais do
                        contrato.
                      </FieldDescription>
                    </Field>
                  </CardContent>
                    ...
                    {hasSecondProposer && (
                      <div className="mt-6 space-y-4">
                        <Field>
                          ...
                          <Select
                            value={selectedSecondProposerId}
                            onValueChange={setSelectedSecondProposerId}
                          >
                          ...
                          <FieldDescription>
                            É preciso que o segundo proponente tenha preenchido
                            o formulário de pré-cadastro devidamente.
                          </FieldDescription>
                        </Field>
                            ...
                            <TabsContent value="contato" className="mt-6">
                              <div className="space-y-4 rounded-lg border p-6">
                                <div className="grid grid-cols-2 gap-4">
                                  ...
                                  {selectedSecondProposer.emergencyContacts
                                    .length > 0 && (
                                    <>
                                      <div className="col-span-2 mt-2">
                                        <Separator />
          ...
          <div className="flex justify-end gap-3 pb-6">
            ...
            <Button size="lg">Criar Contrato</Button>
          </div>
        </div>
      </div>
    </div>
